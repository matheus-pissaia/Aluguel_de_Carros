...
class ControladorClientes():
   ...
   def incluir_cliente(self):
       ...
       cliente = Cliente(dados_cliente["nome"], dados_cliente["cpf"], dados_cliente["telefone"], dados_cliente["idade"])
   ...
   def lista_clientes(self):
       for cliente in self.__clientes:
           self.__tela_cliente.mostra_cliente({"nome": cliente.nome, "telefone": cliente.telefone, "cpf": cliente.cpf, "idade": cliente.idade})
